        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Users_DentistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatmentNotes = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    DelayReason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    DelayDurationMinutes = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SmsNotifications_Users_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_DentistId_Date",
                table: "Schedules",
                columns: new[] { "DentistId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SmsNotifications_PatientId",
                table: "SmsNotifications",
                column: "PatientId");
