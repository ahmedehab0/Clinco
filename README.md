# Clinco with CQRS Pattern

### This is a template and sample, using pure .NET.

I built a simple structure. This project is an implementation of the Clinco with the CQRS Pattern using .NET 9.
The Clinco provides a robust and flexible software design that can easily adapt to changes and maintainability.
...
2. Open the solution file `Clinco.sln` in Visual Studio.
...
The Clinco with CQRS Pattern consists of the following layers:
